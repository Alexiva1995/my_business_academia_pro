   ...
   <div class="col-xs-12">
      ...
      <div style="float:right;">
         @if(Auth::user()->rol_id == 0)
            ...
            <a href="{{route('soporte')}}" class="btn btn-info"><i class="fas fa-arrow-circle-left"></i> Volver al menú principal</a>
         @else
            ...
            <div class="card accordion-academy">
               ...
               <div id="collapse-1" class="collapse" aria-labelledby="heading-1" data-parent="#accordion">
                  <div class="card-body" style="padding-left: 30px; padding-right: 30px;">
                     ...
                     <a href="https://mybusinessacademypro.com/academia/shopping-cart/memberships">https://mybusinessacademypro.com/academia/shopping-cart/memberships</a>
                  </div>
               </div>
               ...
               <div class="card-header" id="heading-3">
                  <h5 class="mb-0">
                     <button class="btn btn-link" data-toggle="collapse" data-target="#collapse-3" aria-expanded="true" aria-controls="collapse-3" style="color: white;">
                        <img src="{{ asset('images/icons/chevron.svg') }}" class="leccion-icon float-right" height="20"> &nbsp; &nbsp;3. ¿Puedo hacer varios cursos a la vez?
                     </button>
                  </h5>
               </div>
               ...
               <div class="card-header" id="heading-4">
                  <h5 class="mb-0">
                     <button class="btn btn-link" data-toggle="collapse" data-target="#collapse-4" aria-expanded="true" aria-controls="collapse-4" style="color: white;">
                        <img src="{{ asset('images/icons/chevron.svg') }}" class="leccion-icon float-right" height="20"> &nbsp; &nbsp;4. ¿Cómo gano a través de Mbapro?
                     </button>
                  </h5>
               </div>
               <div id="collapse-4" class="collapse" aria-labelledby="heading-4" data-parent="#accordion">
                  <div class="card-body" style="padding-left: 30px; padding-right: 30px;">
                     ...
                     <a href="https://mybusinessacademypro.com/academia/afiliados">https://mybusinessacademypro.com/academia/afiliados</a><br><br>
                     Gana como Coach
                     <a href="https://mybusinessacademypro.com/academia/afiliados/coaches">https://mybusinessacademypro.com/academia/afiliados/coaches</a>
                  </div>
               </div>
               ...
               <div class="card-header" id="heading-6">
                  <h5 class="mb-0">
                     <button class="btn btn-link" data-toggle="collapse" data-target="#collapse-6" aria-expanded="true" aria-controls="collapse-6" style="color: white;">
                        <img src="{{ asset('images/icons/chevron.svg') }}" class="leccion-icon float-right" height="20"> &nbsp; &nbsp;6. ¿De qué forma puedo promover los cursos y membresía de MbaPro?
                     </button>
                  </h5>
               </div>
               <div id="collapse-6" class="collapse" aria-labelledby="heading-6" data-parent="#accordion">
                  <div class="card-body" style="padding-left: 30px; padding-right: 30px;">
                     ...
                     Una vez registrado y activo podrás ir a <a href="https://mybusinessacademypro.com/academia/admin">https://mybusinessacademypro.com/academia/admin</a>
