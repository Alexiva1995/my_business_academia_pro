...
<div class="col-md-12 mostrar" style="margin-top: 30px;">
    ...
    <h5 class="text-white pt-2">Al <a href="#" onclick="toggle()">registrarte</a> obtendrás precio preferencial de <b class="text-danger">{{$membresia->discount_annual}} USD </b></h5>
    @else
    <h5 class="text-white pt-2">Al <a href="#" onclick="toggle()">registrarte</a> obtendrás precio preferencial de <b class="text-danger">{{$membresia->descuento}} USD</b></h5>
    @endif
